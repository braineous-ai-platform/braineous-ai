...
import ai.braineous.pay.governance.GovernancePolicyGate;
...
@Path("/pay")
public class GovernancePolicyGateResource {

    @GET
    @Path("/governance/policygate/executions/{queryKind}")
    ...
    public RestResponse<String> getExecutions(@PathParam("queryKind") String queryKind) {
        ...
        try {
            GovernancePolicyGate pg = new GovernancePolicyGate();
    ...
    @POST
    @Path("/governance/policygate/commit/approve")
