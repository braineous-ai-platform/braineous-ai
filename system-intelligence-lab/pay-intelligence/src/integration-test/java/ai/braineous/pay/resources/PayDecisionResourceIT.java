...
public class PayDecisionResourceIT {
    ...
    public void test_reject() {
        ...
        Console.log("it.pay.decision.reject.ingest.in", paymentJson);

        PayIngestionAgent ingestionAgent = new PayIngestionAgent();
        GraphView graph = ingestionAgent.ingestPayment(paymentJson);

        Console.log("it.pay.decision.reject.ingest.out", String.valueOf(graph));
        ...
        Console.log("it.pay.decision.reject.in", body);
        ...
        Console.log("it.pay.decision.reject.out", resp);
        ...
        Console.log("it.pay.decision.reject.rawResponse", rawResponse);
        ...
        Console.log("it.pay.decision.reject.result.decision", result.get("decision").getAsString());
        Console.log("it.pay.decision.reject.result.reason", result.get("reason").getAsString());
        Console.log("it.pay.decision.reject.result.code", result.get("code").getAsString());
